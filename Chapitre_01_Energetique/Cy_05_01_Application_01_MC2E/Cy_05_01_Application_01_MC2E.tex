% "{'classe':('PSI'),'chapitre':'tec_1d','type':('application'),'titre':'Micromanipulateur compact pour la chirurgie endoscopique', 'source':'Concours Commun Mines Ponts 2016','comp':(None),'corrige':True}"
