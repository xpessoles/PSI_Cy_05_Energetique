% "{'classe':('PSI'),'chapitre':'tec','type':('cours'),'titre':'Approche énergétique', 'source':'','comp':('C1-05','C2-08','TEC-01','TEC-02','TEC-03','TEC-04','TEC-05'),'corrige':True}"
\setchapterimage{Fond_CIN.png}
\setchapterpreamble[u]{\margintoc}

\chapter{Approche énergétique}
\marginnote{\xpComp{TEC}{01}\xpComp{TEC}{02}\xpComp{TEC}{03}\xpComp{TEC}{04}\xpComp{TEC}{05}}
%\marginnote[4cm]{
%\UPSTIcompetence[2]{B2-10}
%}

\marginnote[6cm]{\textbf{Émilien Durif}, \textit{Approche énergétique}, Lycée La Martinière Monplaisir, Lyon.}
